...
export default function Contact({}: Props) {
  ...
  return (
    <div className="pt-28 pb-20 w-full grid grid-cols-10 max-w-7xl mx-auto">
      <motion.div
        initial={{
          x: -150,
          opacity: 0,
        ...
        className=" bg-black-100 p-8 rounded-2xl col-span-4"
      >
      ...
      >
        ...
        <img
          className="w-[450px] h-[350px] object-contain absolute top-0 bottom-8 left-8 right-0 m-auto animation"
          src={Logo}
          alt="logo"
        />
      </motion.div>
